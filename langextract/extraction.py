...
def extract(
    ...
    *,
    ...
    Args:
        ...
        response_model: Optional Pydantic BaseModel class to use as the output
          schema constraint. When provided and use_schema_constraints=True,
          the model's output will be constrained to match this schema structure.
          Takes precedence over auto-generated schema from examples.
    ...
    if response_model is not None and not use_schema_constraints:
        warnings.warn(
            "'response_model' provided but 'use_schema_constraints' is False. "
            "The response_model will be ignored. Set use_schema_constraints=True "
            "to use the Pydantic model as a schema constraint.",
            UserWarning,
            stacklevel=2,
        )
