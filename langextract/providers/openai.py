...
class OpenAILanguageModel(base_model.BaseLanguageModel):
    ...
    def get_schema_class(cls) -> type[schema.BaseSchema] | None:
        ...
        Returns:
          ...
          via OpenAI's Structured Outputs feature.
        """
    ...
    def apply_schema(self, schema_instance: schema.BaseSchema | None) -> None:
        ...
        When an OpenAISchema is applied, extracts the response_format config
        to be used in API calls for Structured Outputs.
    ...
    def requires_fence_output(self) -> bool:
        ...
        # Check for explicit override first (from base class)
        if (
        ...
        # Schema-based Structured Outputs: raw JSON output
    ...
    def _process_single_prompt(
        ...
        try:
            ...
            # Priority: Use schema-based Structured Outputs if available,
            # otherwise fall back to basic JSON mode
            if self._response_format is not None:
